    ...
    <header className="mb-8">
      <div className="flex items-start justify-between gap-6">
        <div className="flex-1 min-w-0">
          <h1 className="text-3xl font-bold text-indigo-900 leading-tight">Mindstream</h1>
          <p className="mt-1 text-sm text-slate-600">Your thoughts. Finally understood.</p>
        </div>

        {/* The three-card tray */}
        <div className="ml-4 flex-shrink-0 w-full max-w-2xl">
          <div className="flex gap-3 items-center justify-end flex-wrap">
            ...
            <div className="flex items-center justify-center">
              <div
                ...
                className="flex items-center justify-center w-14 h-14 rounded-full border-2 border-teal-300 bg-white shadow-sm"
                title={streakCount ? `${streakCount}-day streak` : 'No streak yet'}
              >
                <div className="text-center">
                  <div className="text-sm text-slate-500 leading-tight">Streak</div>
              ...
              <div className="rounded-xl border bg-white/60 p-2 shadow-sm flex items-center justify-center">
                ...
                {user ? (
                  <div className="flex items-center gap-3 px-2">
                    <div className="text-sm text-slate-700 truncate max-w-[160px]" title={user.email}>
                      {user.email}
                    </div>
                  ...
                  /* Signed-out state: Google button (visual) + magic link input hidden behind the small input */
