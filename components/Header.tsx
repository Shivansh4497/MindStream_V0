            ...
            <div className="text-sm text-slate-700 flex items-center gap-2 border-r border-slate-200 pr-4">
              ...
              >
                ...
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M19 11V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2h4"
                />
              </svg>
              ...
              {user ? (
                ...
                >
                  ...
                  >
                    <path
                      fill="#4285f4"
                      d="M533.5 278.4c0-17.4-1.6-34.2-4.6-50.6H272v95.8h147.1c-6.4 34.6-25.6 63.8-54.6 82.5v68.5h88.2c51.6-47.5 81.8-117.6 81.8-196.2z"
                    />
                    <path
                      fill="#34a853"
                      d="M272 544.3c73.6 0 135.4-24.3 180.6-66.1l-88.2-68.5c-24.6 16.5-56 26.2-92.4 26.2-71.1 0-131.4-48-153.1-112.3H29.8v70.8C75.6 482.7 168.8 544.3 272 544.3z"
                    />
                    <path
                      fill="#fbbc04"
                      d="M118.9 327.6c-10.9-32.8-10.9-68.2 0-101l-89-70.8C-5.1 188.8-5.1 355.5 29.8 473.5l89.1-70.8z"
                    />
                    <path
                      fill="#ea4335"
                      d="M272 107.5c39.9 0 75.6 13.7 103.8 40.5l77.9-77.9C405.8 24.3 344 0 272 0 168.8 0 75.6 61.6 29.8 153.1l89 70.8C140.6 155.5 200.9 107.5 272 107.5z"
                    />
                  </svg>
